...
namespace rendering {
    ...
    Sprite::Sprite(const char* _img_path, BaseShader& _shader) {
        ...
        this->initDataFromImagePath( _img_path );
    ...
    void Sprite::initDataFromImagePath(const char* _img_path) {
        /////////////////////////////////////////////////////////////////////////////
        //****IMPORTANT****
    ...
    void Sprite::assignBufferTexToData(GLuint textureLoc) {
        texId = textureLoc;
    }
    ...
    void Sprite::draw(BaseCamera& _camera) {
        ...
        this->uvAttribute = glGetAttribLocation(this->programId, "in_texcoord");
    ...
    void Sprite::drawShadowMap(glm::vec3) {
